...
import TherapistList from "../TherapistCard/TherapistCard";
                ...
                <div className="dropdown" onClick={toggleDropdown}>
                  ...
                  {showDropdown && (
                    <div className="dropdown-menu">
                      ...
                      <NavLink to="/center-2">Center 2</NavLink>
                      <NavLink to="/center-3">Center 3</NavLink>
                    </div>
                  )}
                </div>
              </li>
  ...
  return (
    <>
      <Navbar />
            ...
            <div className="hero">
      <h1 className="hero-title">Expert mental programs, information <br /> and resources to help you manage your <span>mental wellbeing.</span></h1>
    ...
    <div className="hero">
      <h1 className="hero-title"><span>What is Mental Health ?</span></h1>
      <img src="skull.png" alt="Brain" className="image1"/>
      <p>Mental health refers to a person's emotional, psychological, and social well-being, affecting how they think, feel, and act. It plays a crucial role in how individuals handle stress, relate to others, and make choices. Good mental health promotes productivity, resilience, and overall life satisfaction. Maintaining mental well-being is essential at every stage of life, from childhood through adulthood.</p>
  
    <div className="mental-health-container">
      <div className="box">
        <span className="icon" role="img" aria-label="mindfulness">🧘‍♂️</span>
        <p>Mindfulness</p>
        <p className="mt-2 text-sm">Mental Clarity: Focus on understanding and processing thoughts clearly.</p>
       
      </div>
      <div className="box">
        <span className="icon" role="img" aria-label="self-care">💆‍♀️</span>
        <p>Self-Care</p>
        <p className="mt-2 text-sm">Emotional Well-being: Nurture and balance your feelings.</p>
      </div>
      <div className="box">
        <span className="icon" role="img" aria-label="therapy">💬</span>
        <p className="mt-2 text-sm">Positive Outlook: Embrace a hopeful and optimistic perspective.</p>
      </div>
    </div>
    ...
    <div className="therapist-section">
      <div className="text-section">
        ...
        <p>
          Find your match from a diverse network of 110+ mental health experts,
          proficient in 15+ languages.
        </p>
        <button className="cta-button">See All Therapists</button>
      </div>
      <div className="image-section">
        <img src="/path-to-your-image1.jpg" alt="Therapist 1" className="therapist-image" />
      </div>
    </div>
